...
Cloud Volumes ONTAP에 대한 용량 기반 라이센스를 볼 때 디지털 지갑에 시장 프라이빗 오퍼와 함께 구입한 라이센스 용량이 표시됩니다.
...
라이센스 용량 또는 기간을 변경하면 이제 Digital Wallet에서 라이센스 조건이 자동으로 업데이트됩니다. 라이센스를 직접 업데이트할 필요는 없습니다.
