...
* https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html["사내 ONTAP 클러스터를 검색하는 방법에 대해 알아보십시오"^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-nss-accounts.html["BlueXP 계정과 연결된 NSS 자격 증명을 관리하는 방법에 대해 알아봅니다"^]
...
. 계약이 만료일에 가깝거나 만료된 경우 BlueXP 콘솔의 오른쪽 하단에 있는 채팅 아이콘을 클릭하여 계약 연장을 요청할 수 있습니다.
. 자세한 내용을 보려면 를 클릭합니다 image:button_down_caret.png["아래쪽 캐럿 아이콘"] 클러스터 정보를 확장합니다.
+
...
https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html["검색 옵션 및 요구 사항에 대해 알아보십시오"^].
...
* https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-manage-ontap-connector.html["Connector로 검색된 클러스터를 관리하는 방법에 대해 알아보십시오"^]
* https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-manage-ontap-direct.html["검색된 클러스터를 직접 관리하는 방법에 대해 알아보십시오"^]
